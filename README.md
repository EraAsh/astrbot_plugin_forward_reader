# Forward Reader v2.0.0 - 智能聊天记录分析助手
...
[![Version](https://img.shields.io/badge/Version-2.0.0-orange)](https://github.com/EraAsh/astrbot_plugin_forward_reader)
...
**Forward Reader v2.0.0** 彻底改变了这一点：
...
> 注意：v2.0.0 优化后，直接分析模式不会携带之前的对话上下文，只针对当前合并消息内容进行分析。
